...
export class signalR {
  ...
  ReconnectHubGroup() {
    console.log("ReconnectHubGroup store", this.store);
    const _store = Store;
    // try {
    //   setTimeout(async () => {
    //     await new Promise((resolve, reject) =>
    //       setTimeout(() => {
    //         this.sto.dispatch("hub/RE_JOIN_HUB_GROUP");
