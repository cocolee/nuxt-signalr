...
import { HubConnectionBuilder, HttpTransportType, JsonHubProtocol, LogLevel, IHttpConnectionOptions } from '@microsoft/signalr'
...
// console.log('IHttpConnectionOptions', IHttpConnectionOptions)
...
export const SignalRHub = {
  Connect: async () => {
    console.log('asdasdasd IHttpConnectionOptions ====> ', IHttpConnectionOptions)
    // _hubConnection
  ...
  ReStart: async () => {
    ...
    await _hubConnection.stop().then((res) => {
