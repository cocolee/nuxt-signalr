...
export const SignalRHub = {
  Connect: () => {
    ...
    console.log('hubUrl: ', process.env.hubUrl)
    // eslint-disable-next-line no-console
    console.log('NODE_ENV: ', process.env.NODE_ENV)
    // eslint-disable-next-line no-console
    const hubSlug = '<%= options.url %>'
    // <%= console.log('_hubConnection 1: ', options.url) %>
    _hubConnection = new signalRCore.HubConnectionBuilder()
    ...
    // eslint-disable-next-line no-console
    // console.log('_hubConnection 2: ', _hubConnection)
  ...
  StartHub: async () => {
    // eslint-disable-next-line no-console
    console.log('connection.start : ', await _hubConnection)
